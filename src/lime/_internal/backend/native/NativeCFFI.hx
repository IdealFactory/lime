...
class NativeCFFI
{
    ...
    @:hlNative("lime", "hl_cairo_text_extents") private static function lime_cairo_text_extents(handle:CFFIPointer, text:String):hl.NativeArray<Float>
    {
        return null;
    }

    @:hlNative("lime", "hl_cairo_font_extents") private static function lime_cairo_font_extents(handle:CFFIPointer):hl.NativeArray<Float>
    {
        return null;
    }
    ...
    @:hlNative("lime", "hl_gl_bind_frag_data_location") private static function lime_gl_bind_frag_data_location(program:Int, colorNumber:Int, name:String):Void {}
